...
8888b.  88 88      88""Yb 888888 88""Yb 
 8I  Yb 88 88      88__dP 88__   88__dP 
 8I  dY 88 88  .o  88""Yb 88""   88"Yb  
8888Y"  88 88ood8  88oodP 888888 88  Yb                                  
                                 """" DILBER ALI 058 "))
 #▬▭▬▭▬▭▬▭[INFO]▬▭▬▭▬▭▬▭#
info=(f"""{style} \x1b[38;5;46mAUTHOR   \033[1;37m➡ \x1b[38;5;46mDILBER CLONER 420
{style} \x1b[38;5;46mTYPE     \033[1;37m➡ \x1b[38;5;46mAUTO CREATE FACEBOOK
{style} \x1b[38;5;46mSTATUS   \033[1;37m➡ \x1b[38;5;46mPAID
{style} \x1b[38;5;46mSYSTEM   \033[1;37m➡ \x1b[38;5;46mDATA/WIFI
{style} \x1b[38;5;46mVERSION  \033[1;37m➡ \x1b[38;5;46m0.7""")
#▬▭▬▭▬▭▬▭[KEY]▬▭▬▭▬▭▬▭#
...
async def sub():
  ...
  async with aiohttp.ClientSession() as sess:
    async with sess.get('https://github.com/IshQkhan/F-8/blob/main/Approved.txt') as appro:
      r1=await appro.text()
      if key1 in r1:
        clear()
        ...
        time.sleep(3.5)
        tks=f"""HELLO ERROR X ETHAN, DEAR ADMIN, PLEASE APPROVE MY KEY TO PAID THANKS.\nYOUR KEY : {key1}"""
        msg=urllib.parse.quote(tks)
        os.system(f'am start -a android.intent.action.VIEW 'f'-d "https://wa.me/+923232706058?text={msg}"')
        await sub()
#▬▭▬▭▬▭▬▭[MAIN MENU]▬▭▬▭▬▭▬▭#
def main():
    clear()
    ...
    for make in range(int(num_accounts)):
        try:
            ...
            if '"registration_succeeded":true' in c.text:
               ...
               print(f'\r\r\x1b[38;5;160m[\x1b[38;5;46mDILBER-OK💚\x1b[38;5;160m] \x1b[38;5;46m{uid} \033[1;37m➡ \x1b[38;5;46m{pww}')
               if 'y' in coki:
                 ...
                 linex()
               try:
                   with open("/sdcard/AUTOCREATE_DILBER/AUTO/MR-TAYYAB-AUTO-CRATE-M1-OK.txt", "a") as f:
                       f.write(f"{uid} | {pww}\n")
                   with open("/sdcard/AUTOCREATE_DILBER/AUTO/MR-TAYYAB-AUTO-CRATE-M1-COOKIE.txt", "a") as f:
                       f.write(f"{uid} | {pww} | {cookie_str}\n")
                   with open("/sdcard/AUTOCREATE_DILBER/AUTO/MR-TAYYAB-AUTO-CRATE-M1-EMAIL.txt", "a") as f:
        ...
        try:
            ...
            if '"registration_succeeded":true' in c.text:
               ...
               if 'y' in coki:
                 ...
                 linex()
               try:
                   with open("/sdcard/AUTOCREATE_DILBER/AUTO/MR-TAYYAB-AUTO-CRATE-M2-OK.txt", "a") as f:
                       f.write(f"{uid} | {pww}\n")
                   with open("/sdcard/AUTOCREATE_DILBER/AUTO/MR-TAYYAB-AUTO-CRATE-M2-COOKIE.txt", "a") as f:
                       f.write(f"{uid} | {pww} | {cookie_str}\n")
                   with open("/sdcard/AUTOCREATE_DILBER/AUTO/MR-TAYYAB-AUTO-CRATE-M2-EMAIL.txt", "a") as f:
                       f.write(f"{email_account}\n")
               except IOError:
                       continue
               ok+=1
    ...
    for make in range(int(num_accounts)):
        try:
            ...
            if '"registration_succeeded":true' in c.text:
               ...
               uid=str(first_cok.get('c_user',''))
               status=check_facebook_profile_picture(uid)
               print(f'\r\r\x1b[38;5;160m[\x1b[38;5;46mDILBER-CLONER-9K💚\x1b[38;5;160m] \x1b[38;5;46m{uid} \033[1;37m➡ \x1b[38;5;46m{pww}')
               if 'y' in coki:
                 colorx=random.choice(["\x1b[38;5;196m","\x1b[38;5;208m","\033[1;30m","\x1b[38;5;160m","\x1b[38;5;46m","\033[1;33m","\033[38;5;6m","\033[1;35m","\033[1;36m","\033[1;37m"])
                 linex()
                 print(f'\r\r\x1b[38;5;160m[\x1b[38;5;46mCOOKIE\x1b[38;5;160m] \033[1;37m🍪 {colorx}{cookie_str}')
                 linex()
               try:
                   with open("/sdcard/AUTOCREATE_DILBER/AUTO/MR-TAYYAB-AUTO-CRATE-M3-OK.txt", "a") as f:
                       f.write(f"{uid} | {pww}\n")
                   with open("/sdcard/AUTOCREATE_DILBER/AUTO/MR-TAYYAB-AUTO-CRATE-M3-COOKIE.txt", "a") as f:
                       f.write(f"{uid} | {pww} | {cookie_str}\n")
                   with open("/sdcard/AUTOCREATE_DILBER/AUTO/MR-TAYYAB-AUTO-CRATE-M3-EMAIL.txt", "a") as f:
                       f.write(f"{email_account}\n")
               except IOError:
                       continue
               ok+=1
...
elif status == "PAID":error(f"{style} \x1b[38;5;46mTOOL IS PAID NOW");time.sleep(4);asyncio.run(bypass())
